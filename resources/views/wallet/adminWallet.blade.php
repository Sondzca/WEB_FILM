...
@section('content_admin')
    <div class="container">
        <h2 class="text-center mb-3">Connect Phantom Wallet</h2>
        <p>Tài khoản này sẽ được sử dụng nhận tiền khi khách hàng thanh toán</p>
        
        <button id="connectWalletButton" class="btn btn-primary mb-3">Connect Wallet</button>
        
        <button id="disconnectWalletButton" class="btn btn-danger mb-3" style="display: none;">Disconnect Wallet</button>
